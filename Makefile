...
Crossplane Targets:
    ...
    build-package         Builds the package package contents in the package package directory (./$(PACKAGE))
    clean-package         Cleans out the generated package package directory (./$(PACKAGE))
